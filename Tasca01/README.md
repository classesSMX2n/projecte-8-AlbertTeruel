...
Anàlisi del "Caos de dades": Identificar els riscos actuals (pèrdua de dades, manca de multiusuari, errors humans).
...
Seguretat i Còpies de Seguretat: Dissenyar un pla per garantir que les dades de facturació i rutes no es perdin mai.
Què cal lliurar
